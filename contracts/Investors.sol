    ...
    */
    ...
    function release() public onlyBeneficiary {
        ...
        if (countRelease < 12) {
            ...
            require(ERC20(PVU_TOKEN).balanceOf(address(this)).sub(AMOUNT_PER_RELEASE_2) >= 0, "TokenTimelock: no tokens to release");
    ...
    function getBalance() public view returns (uint256) {
        return ERC20(PVU_TOKEN).balanceOf(address(this));
    }
